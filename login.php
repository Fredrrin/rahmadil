...
<body>
  <div class="container pt-4 mt-4">
    ...
    ?>
    <h1 class="text-center fw-bold mb-5">Selamat Datang</h1>
    <div class="container mx-auto registerform border rounded mb-5">
      <h3 class="mt-3 text-center fw-bold">Login</h3>
      <p class="text-center text-secondary mb-4">Silahkan masuk untuk melanjutkan</p>
      <form action="" method="POST">
        <div class="mb-3">
          <label for="username" class="form-label">Username<span class="text-danger fw-bold"> *</span></label>
          <input type="text" class="form-control" name="username" required autocomplete="off" value="<?php if (isset($_COOKIE['user_login'])) {
                                                                                                        echo $_COOKIE['user_login'];
                                                                                                      } ?>">
        </div>
        <div class="mb-1">
          <label for="password" class="form-label">Password<span class="text-danger fw-bold"> *</span></label>
          <input type="password" class="form-control" name="password" id="password" required value="<?php if (isset($_COOKIE['user_password'])) {
        ...
        <div class="mb-4">
          <div class="form-check">
            <input class="form-check-input" type="checkbox" value="" id="remember_me" name="remember_me" <?php if (isset($_COOKIE["user_login"])) {
                                                                                                            echo "checked";
                                                                                                          } ?>>
